// ========== مرکز بازی بله (v34: /api/me + fix coins + resilient cron) ==========
...
const CRON_TASKS = {
  ...
  tarfand:      { h: 11, m: 0,  fn: 'section', s: 'tarfand' },
...
export default {
  async fetch(request, env, ctx) {
    ...
    return new Response('🎮 Bale Game Server v34 is running!');
  },
